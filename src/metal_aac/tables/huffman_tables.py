...
# Exact values from ffmpeg libavcodec/aactab.c (ff_aac_scalefactor_bits/code)
SF_CODE_LENGTHS = [
...
# Exact codewords from ffmpeg (ff_aac_scalefactor_code)
SF_CODE_VALUES = [
...
# Exact codewords from ffmpeg codes1[]/bits1[]
CB1_CODES = [
...
def _build_codebook(
    ...
    if codes is not None:
        canonical = [(codes[i], lengths[i]) for i in range(len(lengths))]
    else:
...
CODEBOOKS: dict[int, HuffmanCodebook] = {
    1: _build_codebook(1, 4, True, 1, False, CB1_LENGTHS, CB1_CODES),
    2: _build_codebook(2, 4, True, 1, False, CB2_LENGTHS, CB2_CODES),
    3: _build_codebook(3, 4, False, 2, False, CB3_LENGTHS, CB3_CODES),
    4: _build_codebook(4, 4, False, 2, False, CB4_LENGTHS, CB4_CODES),
    5: _build_codebook(5, 2, True, 4, False, CB5_LENGTHS, CB5_CODES),
    6: _build_codebook(6, 2, True, 4, False, CB6_LENGTHS, CB6_CODES),
    7: _build_codebook(7, 2, False, 7, False, CB7_LENGTHS, CB7_CODES),
    8: _build_codebook(8, 2, False, 7, False, CB8_LENGTHS, CB8_CODES),
    9: _build_codebook(9, 2, False, 12, False, CB9_LENGTHS, CB9_CODES),
    10: _build_codebook(10, 2, False, 12, False, CB10_LENGTHS, CB10_CODES),
    11: _build_codebook(11, 2, False, 16, True, CB11_LENGTHS, CB11_CODES),
}

# Scalefactor codebook — use exact ffmpeg codewords, not canonical generation
SF_CODES: dict[int, tuple[int, int]] = {
    i - 60: (SF_CODE_VALUES[i], SF_CODE_LENGTHS[i]) for i in range(121)
}
